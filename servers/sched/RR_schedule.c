...
int do_noquantum(message *m_ptr)
{
	...
	printf("Round Robin: Process %d consumed timeslice/quantum %d and had Priority %d\n", rmp->endpoint,rmp->time_slice, rmp->priority);
...
int do_start_scheduling(message *m_ptr)
{
	...
	case SCHEDULING_INHERIT:
		...
		/// @brief this line will equalize the priority of all processes
		///which will result in a round robin algorithm
		rmp->priority=7;
